...
export const AIRDROP_PROGRAM_PUBKEY = new PublicKey("DATFQZy5MsVSwgj7TUdwRQdNCxsfGJfMvi9n3BP2zmac");

export const TOKEN_PUBKEY = new PublicKey("CGGVmKPGpDerhsftnC6MpQoDpXa6df8bFeBuM4FtbMon");

export const AIRDROP_SEED = "AIRDROP_SEED";
export const USER_SEED = "USER_SEED";
export const AIRDROP_ID = 1;

export const AIRDROP_AUTHORITY = new PublicKey("vK2ytsyBKnDgPUfsoQQkZcVAEsJqCFWH7xQLzD83MWX");
